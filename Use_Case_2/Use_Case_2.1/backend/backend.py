...
logging.basicConfig(
    filename='Use_Case_2/Use_Case_2.1/backend/backend.log',
    level=logging.DEBUG,
...
client = PersistentClient(path="./Use_Case_2/Use_Case_2.1/backend/chroma_storage")
...
def save_chat():
    ...
    try:
        ...
        save_directory = "./Use_Case_2/Use_Case_2.1/Chat_Saves"
