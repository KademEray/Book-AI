...
def start_backend():
    ...
    backend_path = "./Use_Case_3/Use_Case_3.1/backend/backend.py"
    try:
...
def chat():
    ...
    try:
        # Logdatei löschen
        log_path = "./Use_Case_3/Use_Case_3.1/backend/backend.log"
        if os.path.exists(log_path):
            os.remove(log_path)
            print(f"Logdatei {log_path} gelöscht.")

        # Chroma Storage Ordner löschen
        chroma_storage_path = "./Use_Case_3/Use_Case_3.1/backend/chroma_storage"
