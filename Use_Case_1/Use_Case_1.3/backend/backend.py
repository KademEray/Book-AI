...
logging.basicConfig(
    filename='Use_Case_1/Use_Case_1.3/backend/backend.log',
    level=logging.DEBUG,
...
client = PersistentClient(path="./Use_Case_1/Use_Case_1.3/backend/chroma_storage")
...
def save_chat():
    ...
    try:
        ...
        save_directory = "./Use_Case_1/Use_Case_1.3/Chat_Saves"
